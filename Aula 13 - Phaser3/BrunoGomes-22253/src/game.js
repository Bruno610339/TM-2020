...
game.state.add('play', {
    preload: function() {
        ...
        // Niveis
        this.level = 1;
        // quantos monstros kill neste nivel
        this.levelKills = 0;
        // o numero de monstro necessários para passar nível
    ...
    create: function() {
        ...
        monsterData.forEach(function(data) {
            ...
            //Para puder clicar nos monstros
    ...
    //Função quando click em upgrade
    onUpgradeButtonClick: function(button, pointer) {

        // Quando comprar dar update
    ...
    //Função quando click na moeda
    onClickCoin: function(coin) {
        if (!coin.alive) {
            return;
        }
        // ao apanhar a moeda dar ouro ao player
